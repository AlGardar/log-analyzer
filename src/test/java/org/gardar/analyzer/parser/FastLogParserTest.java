...
class FastLogParserTest {
    ...
    private static final String SAMPLE =
            "192.168.32.181 - - [14/06/2017:16:47:02 +1000] " +
                    "\"PUT /rest/v1.4/documents?zone=default&_rid=6076537c HTTP/1.1\" 200 2 44.510983 " +
    ...
    void returnsEmptyLine() {
        assertTrue(parser.parse("garbage line").isEmpty());
    }
}
